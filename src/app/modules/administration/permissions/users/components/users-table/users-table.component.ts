...
export class UsersTableComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, private snackBar: MatSnackBar,
    private _adminUsersService: AdminUsersService, private _roleService: AdminRolesService) { }
  ...
  handleAddRole(element: ListUser) {
    ...
    MODAL?.result?.then((data) => {//NOS SUBSCRIBIMOS A LA RESPUESTA DE LOS ROLES
